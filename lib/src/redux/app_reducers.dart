...
import 'package:multi_camera_photography_fe/src/redux/reducers/app_permissions.reducers.dart';
...
AppState appReducer(AppState state, dynamic action) {
  return AppState.updatedState(
      ...
      appPermissions: appPermissionsReducer(state.appPermissions, action));
}
